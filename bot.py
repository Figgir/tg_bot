...
🤍 Добро пожаловать в молитвенную группу.

Мы рады, что вы здесь. Это пространство поддержки и живой молитвы.

Вы можете:
✨ оставить молитвенную нужду

Напишите свою просьбу одним сообщением.
Если хотите анонимно — укажите это в тексте.
Мы передадим её команде и будем молиться.

Пусть Бог укрепит вас 🙏
""")
